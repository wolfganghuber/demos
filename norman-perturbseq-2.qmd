...
ggplot(fits, aes(x = beta1, y = beta2, col = log(res))) + 
  geom_abline(slope = -1, intercept = 1.5) + geom_point() + coord_fixed() + scale_x_continuous(breaks = b) + scale_y_continuous(breaks = b)
ggplot(fits, aes(x = beta1, y = beta2, col = res <= median(res))) + 
  geom_abline(slope = -1, intercept = 1.5) + geom_point() + coord_fixed() + scale_x_continuous(breaks = b) + scale_y_continuous(breaks = b)
```